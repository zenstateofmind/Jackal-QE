...
public class UnixProcessTest extends ProcessTest {
    ...
    protected void copyTestClassFile() throws Exception {
        ...
        System.out.println("URL: "+classFile.toString());

        assertNotNull(classFile);
        File copiedFile = new File(testDir, classFileName);
        System.out.println("copiedFIle: "+copiedFile.toString());
    ...
    protected void setUp() {
        ...
        System.out.println("Test directory: "+testDir.toString());
    }

    public void testAcquire() throws Exception {
        assertNotNull("Java executable exists", ProcessTest.javaBin);
        System.out.println("Absolute Path: "+ProcessTest.javaBin.getAbsolutePath());
        System.out.println("Name: " + ProcessTest.javaBin.getName());
